...
<div class="container py-5">
            ...
            <div class="p-4 rounded-4 shadow-sm h-100" style="background-color: #FFF9FB;">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center">
                        <div class="me-2">
                            @for ($i = 1; $i <= 5; $i++)
                                <i class="fas fa-star" style="color: {{ $i <= 4 ? '#FFD700' : '#E0E0E0' }};"></i>
                            @endfor
                        </div>
                ...
                <div class="d-flex gap-3 mt-4">
                    <a href="{{ route('addToCart', $item->item_id) }}" class="btn btn-lg rounded-pill w-75 py-3" 
                       style="background-color: #FF6B9E; color: white; transition: all 0.3s; text-align: center; display:center;">
    ...
    <div class="mt-5 pt-5">
                    ...
                    <div class="card-body p-4" style="background-color: #FFF9FB;">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-0" style="color: #8A6FDF;">{{ $review->customer_name ?? 'Anonymous' }}</h6>
        ...
        <div class="text-center p-5 rounded-4 shadow-sm" style="background-color: #FFF5F8;">
            ...
            <p class="text-muted">Be the first to review this adorable plushie!</p>
            <button class="btn rounded-pill px-4 py-2" style="background-color: #FF6B9E; color: white;">
